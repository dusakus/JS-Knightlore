...
window.asap = {
	...
	playA : function(filename,module){
		window.asap.play(filename,module,1)
	},
	playB : function(filename,module){
		window.asap.play(filename,module,0)
	},
	playC : function(filename,module){
		window.asap.play(filename,module,2)
	},
	play : function(filename, module, song)
	{
		...
		window.asap.asap = asap;
		window.asap.info = info;
		window.asap.onLoad();
